...
export declare type Column = Array<ColumnDescriptor>;
export declare type Row = Array<string | number | boolean>;
...
export interface Connection {
    ...
    create: (query: string, options: CreateTableOptions) => Promise<ContractReceipt>;
