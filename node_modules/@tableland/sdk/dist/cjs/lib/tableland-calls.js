...
exports.write = exports.read = exports.receipt = exports.list = exports.hash = void 0;
...
function hash(query) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return (0, util_js_1.camelCaseKeys)(json.result);
    });
}
exports.hash = hash;
function read(query) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return (0, util_js_1.camelCaseKeys)(json.result.data);
    });
}
exports.read = read;
...
function write(query) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const json = yield SendCall.call(this, message, (_a = this.token) === null || _a === void 0 ? void 0 : _a.token);
        return (0, util_js_1.camelCaseKeys)(json.result.tx);
    });
}
exports.write = write;
function receipt(txnHash) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (json.result.receipt) {
            return (0, util_js_1.camelCaseKeys)(json.result.receipt);
        }
        return undefined;
    });
}
